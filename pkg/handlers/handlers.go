...
Сгенерируй 15 рекомендаций, которые идеально подходят по духу, смыслу, категории (%s), эпохе и жанру к "Теме списка" и похожи на элементы из Текущего списка пользователя.
