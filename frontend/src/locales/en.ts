...
export const en: Translations = {
  ...
  lists: {
    ...
    folder_svoe: 'Domestic',
    folder_foreign: 'Foreign',
    folder_misc: 'Miscellaneous',
    folder_order: 'Folder Order',
    folder_order_empty: 'No folders to sort',
    folder_order_done: 'Done',
    ai_selection: 'AI Picks',
    recommendations_for: 'Recommendations for:',
    found_new_recommendations: 'Found {count} new recommendations',
    refresh: 'Refresh',
    try_again: 'Try Again',
    in_your_list: 'In your list',
    ai_analyzing: 'AI is analyzing your list and picking the best...',
    ai_failed_to_load: 'Failed to load recommendations.',
    ai_error_loading: 'Error loading recommendations.',
    ai_cooldown_wait: 'Please wait {min}m {sec}s before refreshing again.',
    item_added_toast: '"{title}" added to your collection!',
